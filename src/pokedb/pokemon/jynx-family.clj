...
(deflearnset :rs
  ...
  :jynx [:brick-break :doubleslap :focus-punch :hyper-beam :lovely-kiss :taunt :torment])
...
(deflearnset :dp
  ...
  :jynx [:body-slam :brick-break :doubleslap :drain-punch :energy-ball :focus-blast :focus-punch :giga-impact :headbutt :hyper-beam :lovely-kiss :taunt :torment :wake-up-slap :wring-out])
