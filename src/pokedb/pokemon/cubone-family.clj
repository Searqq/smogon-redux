...
(deflearnset :dp
  :cubone [:aerial-ace :ancientpower :attract :belly-drum :blizzard :bone-club :bone-rush :bonemerang :brick-break :captivate :detect :dig :double-edge :double-kick :double-team :earth-power :earthquake :endeavor :endure :facade :false-swipe :fire-blast :fire-punch :flamethrower :fling :focus-energy :focus-punch :frustration :fury-cutter :growl :headbutt :hidden-power :ice-beam :icy-wind :iron-defense :iron-head :iron-tail :knock-off :leer :low-kick :mud-slap :natural-gift :perish-song :protect :rage :rest :return :rock-climb :rock-slide :rock-smash :rock-tomb :sandstorm :screech :secret-power :skull-bash :sleep-talk :snore :stealth-rock :strength :substitute :sunny-day :swagger :swords-dance :tail-whip :thief :thrash :thunderpunch :toxic :uproar]
