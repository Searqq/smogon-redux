...
(deflearnset :dp
  ...
  :mantine [:aqua-tail :brine :bullet-seed :defog :giga-impact :gunk-shot :hyper-beam :iron-head :psybeam :rock-tomb :seed-bomb :string-shot :tailwind])
...
(deflearnset :bw
  ...
  :mantine [:aqua-tail :bullet-seed :giga-impact :gunk-shot :hyper-beam :iron-head :psybeam :rock-tomb :seed-bomb :tailwind])
