...
(defpokemon :mawile
  ...
  :abilities [[:hyper-cutter :intimidate]
              :bw [:hyper-cutter :intimidate :sheer-force]]
...
(deflearnset :bw
  :kecleon [:aerial-ace :after-you :ancientpower :aqua-tail :astonish :attract :bind :blizzard :brick-break :charge-beam :cut :dig :disable :dizzy-punch :double-team :drain-punch :facade :faint-attack :fake-out :feint :fire-blast :fire-punch :flamethrower :flash :fling :foul-play :frustration :fury-swipes :grass-knot :hidden-power :hone-claws :ice-beam :ice-punch :icy-wind :incinerate :iron-tail :knock-off :last-resort :lick :low-kick :magic-coat :nasty-plot :protect :psybeam :psych-up :rain-dance :recover :recycle :rest :retaliate :return :rock-slide :rock-smash :rock-tomb :role-play :round :scratch :screech :shadow-ball :shadow-claw :shadow-sneak :skill-swap :slash :sleep-talk :snatch :snore :solarbeam :stealth-rock :strength :substitute :sucker-punch :sunny-day :swagger :synchronoise :tail-whip :thief :thunder :thunder-wave :thunderbolt :thunderpunch :toxic :trick :trick-room :wonder-room :work-up])




(deflearnset :rs
  :lunatone [:body-slam :calm-mind :confusion :cosmic-power :defense-curl :double-edge :double-team :dream-eater :earthquake :endure :explosion :facade :flash :frustration :future-sight :harden :hidden-power :hyper-beam :hypnosis :ice-beam :light-screen :mimic :protect :psych-up :psychic :psywave :rain-dance :reflect :rest :return :rock-slide :rock-throw :rock-tomb :rollout :safeguard :sandstorm :secret-power :selfdestruct :shadow-ball :skill-swap :sleep-talk :snore :substitute :swagger :swift :tackle :toxic])

(deflearnset :dp
  :lunatone [:ancientpower :blizzard :calm-mind :charge-beam :confusion :cosmic-power :double-team :dream-eater :earth-power :earthquake :embargo :endure :explosion :facade :flash :frustration :future-sight :giga-impact :grass-knot :gravity :gyro-ball :harden :heal-block :helping-hand :hidden-power :hyper-beam :hypnosis :ice-beam :iron-head :light-screen :magic-coat :natural-gift :pain-split :protect :psych-up :psychic :psywave :rain-dance :recycle :reflect :rest :return :rock-polish :rock-slide :rock-throw :rock-tomb :rollout :safeguard :sandstorm :secret-power :shadow-ball :signal-beam :skill-swap :sleep-talk :snore :stealth-rock :stone-edge :substitute :swagger :swift :tackle :toxic :trick-room :zen-headbutt])

(deflearnset :bw
  :lunatone [:acrobatics :blizzard :bulldoze :calm-mind :charge-beam :confusion :cosmic-power :double-team :dream-eater :earth-power :earthquake :embargo :explosion :facade :flash :frustration :future-sight :giga-impact :grass-knot :gravity :gyro-ball :harden :heal-block :helping-hand :hidden-power :hyper-beam :hypnosis :ice-beam :icy-wind :iron-head :light-screen :magic-coat :magic-room :pain-split :protect :psych-up :psychic :psyshock :psywave :rain-dance :recycle :reflect :rest :return :rock-polish :rock-slide :rock-throw :rock-tomb :round :safeguard :sandstorm :shadow-ball :signal-beam :skill-swap :sleep-talk :smack-down :snore :stealth-rock :stone-edge :substitute :swagger :tackle :telekinesis :toxic :trick-room :zen-headbutt])
...
(deflearnset :rs
  :mawile [:ancientpower :astonish :attract :baton-pass :bite :body-slam :brick-break :counter :crunch :double-edge :double-team :dynamicpunch :endure :facade :faint-attack :fake-tears :false-swipe :fire-blast :flamethrower :focus-punch :frustration :hidden-power :hyper-beam :ice-beam :ice-punch :icy-wind :iron-defense :mega-kick :mega-punch :mimic :mud-slap :poison-fang :protect :psych-up :rain-dance :rest :return :rock-slide :rock-smash :rock-tomb :sandstorm :secret-power :seismic-toss :sleep-talk :sludge-bomb :snore :solarbeam :spit-up :stockpile :strength :substitute :sunny-day :swagger :swallow :sweet-scent :swords-dance :taunt :thunderpunch :tickle :torment :toxic :vicegrip])

(deflearnset :dp
  :mawile [:ancientpower :astonish :attract :baton-pass :bite :brick-break :captivate :charge-beam :crunch :dark-pulse :double-team :embargo :endure :facade :faint-attack :fake-tears :false-swipe :fire-blast :fire-fang :flamethrower :flash-cannon :fling :focus-blast :focus-punch :frustration :giga-impact :grass-knot :guard-swap :headbutt :hidden-power :hyper-beam :ice-beam :ice-fang :ice-punch :icy-wind :iron-defense :iron-head :knock-off :magnet-rise :mud-slap :natural-gift :pain-split :payback :poison-fang :protect :psych-up :punishment :rain-dance :rest :return :rock-slide :rock-smash :rock-tomb :sandstorm :secret-power :shadow-ball :sleep-talk :sludge-bomb :snore :solarbeam :spit-up :stockpile :strength :substitute :sucker-punch :sunny-day :super-fang :swagger :swallow :sweet-scent :swords-dance :taunt :thunder-fang :thunderpunch :tickle :torment :toxic :vicegrip])

(deflearnset :bw
  :mawile [:ancientpower :astonish :attract :baton-pass :bite :brick-break :captivate :charge-beam :crunch :dark-pulse :double-team :embargo :facade :faint-attack :fake-tears :false-swipe :fire-blast :fire-fang :flamethrower :flash-cannon :fling :focus-blast :foul-play :frustration :giga-impact :grass-knot :guard-swap :hidden-power :hyper-beam :ice-beam :ice-fang :ice-punch :icy-wind :incinerate :iron-defense :iron-head :knock-off :last-resort :magnet-rise :metal-burst :pain-split :payback :poison-fang :protect :psych-up :punishment :rain-dance :rest :return :rock-slide :rock-smash :rock-tomb :round :sandstorm :shadow-ball :slam :sleep-talk :sludge-bomb :snatch :snore :solarbeam :spit-up :stealth-rock :stockpile :stone-edge :strength :substitute :sucker-punch :sunny-day :super-fang :swagger :swallow :sweet-scent :swords-dance :taunt :thunder-fang :thunderpunch :tickle :torment :toxic :vicegrip])
...
(deflearnset :rs
  :torkoal [:amnesia :attract :body-slam :curse :double-edge :double-team :ember :endure :eruption :explosion :facade :fire-blast :fire-spin :flail :flamethrower :frustration :heat-wave :hidden-power :iron-defense :iron-tail :mimic :mud-slap :overheat :protect :rest :return :rock-slide :rock-smash :secret-power :selfdestruct :sleep-talk :sludge-bomb :smog :smokescreen :snore :strength :substitute :sunny-day :swagger :toxic :yawn])

(deflearnset :dp
  :torkoal [:amnesia :attract :body-slam :captivate :curse :double-team :earth-power :earthquake :ember :endure :eruption :explosion :facade :fire-blast :fire-spin :fissure :flail :flamethrower :frustration :giga-impact :gyro-ball :headbutt :heat-wave :hidden-power :hyper-beam :iron-defense :iron-tail :lava-plume :mud-slap :natural-gift :overheat :protect :rapid-spin :rest :return :rock-slide :rock-smash :rock-tomb :rollout :secret-power :skull-bash :sleep-talk :sludge-bomb :smog :smokescreen :snore :solarbeam :stealth-rock :stone-edge :strength :substitute :sunny-day :swagger :toxic :will-o-wisp :withdraw :yawn])

(deflearnset :bw
  :torkoal [:after-you :amnesia :attract :body-slam :bulldoze :clear-smog :curse :double-team :earth-power :earthquake :ember :endure :eruption :explosion :facade :fire-blast :fire-spin :fissure :flail :flame-burst :flame-charge :flamethrower :frustration :giga-impact :gyro-ball :heat-wave :hidden-power :hyper-beam :incinerate :inferno :iron-defense :iron-tail :lava-plume :overheat :protect :rapid-spin :rest :return :rock-slide :rock-smash :rock-tomb :round :shell-smash :skull-bash :sleep-talk :sludge-bomb :smog :smokescreen :snore :solarbeam :stealth-rock :stone-edge :strength :substitute :sunny-day :swagger :toxic :will-o-wisp :withdraw :yawn])
