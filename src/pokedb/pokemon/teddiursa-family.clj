...
(deflearnset :rs
  ...
  :ursaring [:hyper-beam :rock-slide :rock-tomb])
...
(deflearnset :dp
  ...
  :ursaring [:avalanche :focus-blast :giga-impact :hammer-arm :hyper-beam :low-kick :rock-climb :scary-face :stone-edge :uproar])
...
(deflearnset :bw
  ...
  :ursaring [:focus-blast :giga-impact :hammer-arm :hyper-beam :low-kick :scary-face :smack-down :stone-edge :uproar])
