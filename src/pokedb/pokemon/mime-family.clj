...
(deflearnset :dp
  ...
  :mr-mime [:aerial-ace :energy-ball :fire-punch :focus-blast :giga-impact :guard-swap :hyper-beam :ice-punch :iron-defense :magical-leaf :payback :power-swap :thunderpunch :zen-headbutt])
