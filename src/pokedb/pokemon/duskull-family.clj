...
(deflearnset :rs
  ...
  :dusclops [:bind :counter :dynamicpunch :earthquake :fire-punch :focus-punch :hyper-beam :ice-punch :mega-kick :mega-punch :metronome :mud-slap :rock-slide :rock-smash :rock-tomb :seismic-toss :shadow-punch :strength :thunderpunch])
...
(deflearnset :dp
  ...
  :dusclops [:bind :brick-break :earthquake :fire-punch :focus-punch :giga-impact :hyper-beam :ice-punch :mud-slap :rock-slide :rock-smash :rock-tomb :shadow-punch :strength :thunderpunch]
...
(deflearnset :bw
  ...
  :dusclops [:bind :brick-break :bulldoze :earthquake :fire-punch :giga-impact :hyper-beam :ice-punch :rock-slide :rock-smash :rock-tomb :shadow-punch :strength :thunderpunch]
  :dusknoir [:focus-blast])
