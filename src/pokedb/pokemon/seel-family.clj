...
(deflearnset :gs
  :seel [:attract :aurora-beam :blizzard :curse :disable :double-team :encore :endure :frustration :growl :headbutt :hidden-power :ice-beam :icy-wind :lick :peck :perish-song :protect :rain-dance :rest :return :safeguard :slam :sleep-talk :snore :surf :swagger :take-down :toxic :waterfall :whirlpool]
  :dewgong [:hyper-beam])
