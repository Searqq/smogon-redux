...
(deflearnset :rs
  ...
  :jigglypuff [:blizzard :brick-break :disable :doubleslap :dynamicpunch :fire-punch :focus-punch :hyper-voice :ice-beam :ice-punch :snatch :strength :thunder :thunderbolt :thunderpunch]
  :wigglytuff [:hyper-beam])
...
(deflearnset :dp
  ...
  :jigglypuff [:blizzard :body-slam :brick-break :charge-beam :disable :double-edge :doubleslap :drain-punch :fire-punch :focus-punch :gyro-ball :hyper-voice :ice-beam :ice-punch :knock-off :mimic :snatch :stealth-rock :strength :thunder :thunderbolt :thunderpunch :wake-up-slap]
