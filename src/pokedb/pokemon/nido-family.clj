...
(deflearnset :rs
  ...
  :nidoqueen [:brick-break :dynamicpunch :earthquake :fire-blast :fire-punch :flamethrower :focus-punch :fury-cutter :hyper-beam :ice-punch :icy-wind :mega-kick :mega-punch :roar :rock-slide :rock-tomb :sandstorm :seismic-toss :shadow-ball :superpower :surf :taunt :thunderpunch :torment])
