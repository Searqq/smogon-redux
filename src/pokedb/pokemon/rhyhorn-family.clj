...
(deflearnset :rs
  ...
  :rhydon [:brick-break :cut :dynamicpunch :fire-punch :focus-punch :fury-cutter :hyper-beam :mega-kick :mega-punch :seismic-toss :surf :thunderpunch])
...
(deflearnset :dp
  ...
  :rhydon [:avalanche :block :brick-break :cut :fire-punch :fling :focus-blast :focus-punch :fury-cutter :giga-impact :hammer-arm :hyper-beam :ice-punch :outrage :shadow-claw :surf :thunderpunch :whirlpool]
