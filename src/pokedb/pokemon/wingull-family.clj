...
(deflearnset :rs
  ...
  :pelipper [:hydro-pump :hyper-beam :spit-up :stockpile :surf :swallow])
...
(deflearnset :dp
  ...
  :pelipper [:fling :giga-impact :gunk-shot :hydro-pump :hyper-beam :payback :seed-bomb :sky-attack :spit-up :stockpile :surf :swallow :whirlpool])
...
(deflearnset :bw
  ...
  :pelipper [:fling :giga-impact :gunk-shot :hydro-pump :hyper-beam :payback :seed-bomb :sky-attack :sky-drop :soak :spit-up :stockpile :surf :swallow])
