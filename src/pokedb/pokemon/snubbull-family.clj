...
(deflearnset :rs
  ...
  :granbull [:hyper-beam :iron-tail :rock-slide :rock-tomb])
...
(deflearnset :dp
  ...
  :granbull [:focus-blast :giga-impact :hyper-beam :iron-tail :rock-climb :rock-slide :rock-tomb :stone-edge])
...
(deflearnset :bw
  ...
  :granbull [:focus-blast :giga-impact :hyper-beam :iron-tail :outrage :rock-slide :rock-tomb :stone-edge])
