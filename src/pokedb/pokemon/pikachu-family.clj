...
(deflearnset :rs
  ...
  :pikachu [:agility :brick-break :dig :dynamicpunch :focus-punch :growl :quick-attack :rock-smash :slam :strength :thunderpunch :fly]
  :raichu [:hyper-beam :thief])
...
(deflearnset :dp
  ...
  :pikachu [:agility :brick-break :dig :discharge :feint :focus-punch :growl :knock-off :quick-attack :rock-smash :slam :strength :surf :last-resort :yawn :fly]
...
(deflearnset :bw
  ...
  :pikachu [:agility :brick-break :dig :discharge :electro-ball :feint :growl :knock-off :quick-attack :rock-smash :slam :strength :fly :sing :extremespeed :surf :last-resort :yawn]
  :raichu [:focus-blast :giga-impact :hyper-beam :thief])
