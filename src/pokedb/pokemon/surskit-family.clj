...
(deflearnset :rs
  ...
  :masquerain [:aerial-ace :gust :hyper-beam :nightmare :scary-face :silver-wind :stun-spore :whirlwind])
...
(deflearnset :dp
  ...
  :masquerain [:aerial-ace :air-cutter :air-slash :bug-buzz :defog :energy-ball :giga-impact :gust :hyper-beam :ominous-wind :roost :scary-face :silver-wind :stun-spore :tailwind :twister :u-turn :whirlwind])

(deflearnset :bw
  :surskit [:agility :aqua-jet :attract :baton-pass :blizzard :bubble :bubblebeam :bug-bite :double-team :endure :facade :flash :foresight :frustration :giga-drain :haze :hidden-power :hydro-pump :ice-beam :icy-wind :mind-reader :mist :mud-shot :protect :psybeam :psych-up :quick-attack :rain-dance :rest :return :round :scald :shadow-ball :signal-beam :sleep-talk :snore :solarbeam :struggle-bug :substitute :sunny-day :swagger :sweet-scent :thief :toxic :water-sport]
  :masquerain [:aerial-ace :air-slash :bug-buzz :energy-ball :giga-impact :gust :hyper-beam :ominous-wind :quiver-dance :roost :scary-face :silver-wind :stun-spore :tailwind :u-turn :whirlwind])
