...
(deflearnset :rs
  ...
  :slowbro [:brick-break :counter :dynamicpunch :focus-punch :fury-cutter :hyper-beam :ice-punch :mega-kick :mega-punch :rock-smash :seismic-toss :withdraw])
...
(deflearnset :dp
  ...
  :slowbro [:avalanche :brick-break :drain-punch :fling :focus-blast :focus-punch :fury-cutter :giga-impact :hyper-beam :ice-punch :iron-defense :rock-smash :withdraw]
  :slowking [:nasty-plot :power-gem :trump-card])
