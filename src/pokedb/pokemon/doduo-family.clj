...
(deflearnset :gs
  :doduo [:agility :attract :curse :double-team :drill-peck :endure :faint-attack :flail :fly :frustration :fury-attack :growl :haze :hidden-power :mud-slap :peck :protect :pursuit :quick-attack :rage :rest :return :sleep-talk :snore :steel-wing :sunny-day :supersonic :swagger :swift :thief :toxic :tri-attack]
  :dodrio [:hyper-beam])
...
(deflearnset :rs
  ...
  :dodrio [:hyper-beam :taunt :torment])
