...
(deflearnset :rs
  ...
  :glalie [:defense-curl :earthquake :explosion :hyper-beam :rollout :selfdestruct :sheer-cold :taunt :torment])
...
(deflearnset :dp
  ...
  :glalie [:dark-pulse :earthquake :explosion :gyro-ball :iron-head :sheer-cold :super-fang])

(deflearnset :bw
  :snorunt [:attract :avalanche :bide :bite :blizzard :block :crunch :disable :double-team :facade :fake-tears :flash :frost-breath :frustration :hail :headbutt :hex :hidden-power :ice-beam :ice-fang :ice-shard :icy-wind :leer :light-screen :powder-snow :protect :rain-dance :rest :return :rollout :round :safeguard :shadow-ball :sleep-talk :snore :spikes :spite :substitute :swagger :toxic :weather-ball]
  ...
  :glalie [:bulldoze :dark-pulse :earthquake :explosion :gyro-ball :iron-head :sheer-cold :super-fang])
