...
(deflearnset :rs
  ...
  :golduck [:fury-cutter :hyper-beam :charm])
...
(deflearnset :dp
  ...
  :golduck [:aqua-jet :focus-blast :fury-cutter :giga-impact :hyper-beam :low-kick :rock-climb :charm])
...
(deflearnset :bw
  ...
  :golduck [:aqua-jet :focus-blast :giga-impact :hyper-beam :low-kick :low-sweep :charm])
