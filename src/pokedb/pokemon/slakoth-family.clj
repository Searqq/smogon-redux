...
(deflearnset :dp
  ...
  :vigoroth [:earthquake :focus-blast :focus-energy :fury-swipes :low-kick :reversal :roar :rock-climb :taunt :uproar]
  :slaking [:block :giga-impact :hyper-beam :punishment])
