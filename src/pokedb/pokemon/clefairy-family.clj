...
(deflearnset :rs
  ...
  :clefairy [:blizzard :brick-break :calm-mind :cosmic-power :doubleslap :dynamicpunch :fire-punch :focus-punch :follow-me :growl :ice-beam :ice-punch :meteor-mash :minimize :moonlight :snatch :strength :thunder :thunderbolt :thunderpunch]
  :clefable [:hyper-beam])
...
(deflearnset :dp
  ...
  :clefairy [:blizzard :bounce :brick-break :calm-mind :charge-beam :cosmic-power :defense-curl :doubleslap :drain-punch :fire-punch :focus-punch :follow-me :growl :heal-bell :healing-wish :ice-beam :ice-punch :knock-off :lucky-chant :meteor-mash :minimize :moonlight :rock-smash :snatch :stealth-rock :strength :thunder :thunderbolt :thunderpunch :wake-up-slap]
