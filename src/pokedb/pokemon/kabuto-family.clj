...
(deflearnset :rs
  ...
  :kabutops [:brick-break :cut :dive :fury-cutter :hyper-beam :mega-kick :seismic-toss :slash :swords-dance])
...
(deflearnset :dp
  ...
  :kabutops [:aerial-ace :aqua-tail :brick-break :cut :dive :feint :fury-cutter :giga-impact :headbutt :hyper-beam :low-kick :night-slash :rock-climb :slash :stone-edge :superpower :swords-dance :x-scissor])
