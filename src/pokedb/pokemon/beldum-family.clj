...
(deflearnset :dp
  ...
  :metagross [:block :giga-impact :hammer-arm :body-slam :body-slam :double-edge :icy-wind :mimic :selfdestruct])
...
(deflearnset :bw
  ...
  :metagross [:block :giga-impact :hammer-arm :body-slam :double-edge :icy-wind :mimic :selfdestruct])
